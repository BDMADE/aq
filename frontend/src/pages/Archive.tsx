...
import ArchiveArtists from "../components/Artist/ArchiveArtists";
...
const Archive = () => {
    ...
    let visibleArtists: boolean = data.artistPage.settings.visibleArtists;
    ...
    return (
        <>
            ...
            <div className="container-fluid">
                <article id="post-2" className="ct-page__entry-content post-2 page type-page status-publish">
                    { visibleArtists && <ArchiveArtists/> }
                </article>
            </div>
        </>
    );
